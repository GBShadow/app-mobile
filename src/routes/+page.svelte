<script lang="ts">
	...
	import { Button, NavBar } from 'stdf';
...
<NavBar
	...
	titleAlign="center"
	injClass="!text-white font-bold h-16 pt-4"
	left={null}
/>
	...
	<div class="grid grid-cols-1 place-items-center bg-primary-500 p-4 text-white">
		...
		<div class="w-full overflow-x-auto">
			<table class="min-w-full divide-y divide-white">
				<thead class="">
					<tr>
						<th scope="col" class="px-4 py-3.5 text-left text-sm font-normal text-white">Código</th>
						<th scope="col" class="px-4 py-3.5 text-left text-sm font-normal text-white">Nome</th>
						<th scope="col" class="px-4 py-3.5 text-left text-sm font-normal text-white"
							>Quantidade</th
						>
						<th scope="col" class="px-4 py-3.5 text-left text-sm font-normal text-white">Vl. Uni</th
						>
						<th scope="col" class="px-4 py-3.5 text-left text-sm font-normal text-white"
							>Vl. Total</th
						>
